...
#
# $Id: cext_pape_traffic_assign.py 784 2011-10-05 04:31:45Z astivala $
# 
###############################################################################
...
d'Esopo-Pape algorithm to make it faster (since > 90% of time is spent
...
#        sys.stderr.write("running d'Esopo-Pape for orig %d..." % orig)
#        t0 = clock()
        pred = pape.pape(orig)
#        t1 = clock()
...
def main():
    ...
    # this must be sorted by from node ascending and then to node to match
    ...
    # the structure of the graph never changes but only weights do
