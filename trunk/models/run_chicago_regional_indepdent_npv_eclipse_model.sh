#!/bin/sh
#
# $Id: run_chicago_regional_indepdent_npv_eclipse_model.sh 740 2011-09-22 02:39:43Z astivala $
#
...
mzn2fzn --output-to-stdout upgrade_schedule_independent_npv.mzn $DZN_FILE | eclipse -e "flatzinc:fzn_run(fzn_ic)" | ../scripts/convert_eclipse_output_schedule_to_id_schedule.py -c $DZN_FILE
